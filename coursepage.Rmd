...
```{r diceroll2, out.width = '40%', echo=FALSE, fig.align="center", fig.cap="Sampling Distribution: Two Dice Rolls per Sample"}
 knitr::include_graphics('coursepage_files/diceroll2.gif')
```
...
knitr::include_graphics('coursepage_files/diceroll10.gif')
```
...
knitr::include_graphics('coursepage_files/diceroll100.gif')
```
...
knitr::include_graphics('coursepage_files/lln.gif')
```
